# Generated by Django 3.2.5 on 2021-10-31 18:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sermar', '0004_collection_disposition'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collector', models.CharField(blank=True, default='Denné Reed', max_length=50, null=True)),
                ('finder', models.CharField(blank=True, default='Denné Reed', max_length=50, null=True)),
                ('loan', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('image', models.FileField(blank=True, max_length=255, null=True, upload_to='uploads/images/drp')),
        ...
        migrations.CreateModel(
            name='Biology',
            fields=[
                ('occurrence_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='sermar.occurrence')),
                ...
                ('morphotype_id', models.IntegerField(blank=True, null=True)),
            ],
            options={
                'verbose_name': 'Biology',
                'verbose_name_plural': 'DRP Biology',
            },
            bases=('sermar.occurrence',),
        ),
    ]
