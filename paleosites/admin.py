...
class DateTabInline(admin.TabularInline):
    model = Date
    extra = 1
    fields = ['layer', 'industry', 'cat_no', 'date', 'technique']
...
class SiteAdmin(admin.ModelAdmin):
    ...
    fieldsets = [(None, {
                 'fields': [('site', 'site_type', 'data_source', 'display'),
                            ('latitude', 'longitude', 'altitude', 'country'),
                            ('map_location', 'notes')]})]
    readonly_fields = ('latitude', 'longitude', 'min_date', 'max_date')
    list_display = ('site', 'site_type', 'min_date', 'max_date', 'country', 'data_source')
