...
from . import views as psr_views

urlpatterns = [
    # Project URLs are included by main urls.py

    # # /projects/mlp/confirmation/
    # url(r'^confirmation/$', psr_views.Confirmation.as_view(), name="mlp_upload_confirmation"),
    #
    ...
    #url(r'^upload/', psr_views.ImportAccessDatabase.as_view(), name = "psr_upload_mdb")
